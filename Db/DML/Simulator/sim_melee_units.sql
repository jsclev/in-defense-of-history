...
-- min/max_damage bracket the unit's attack_rating (its average swing damage);
-- the engine's fixed roll band spreads around whichever rating is chosen.
INSERT INTO sim_melee_unit (id, tower_id, min_hp, max_hp, min_damage, max_damage) VALUES
('5e0ee001-0000-4000-8000-000000000001', '3d7e4f95-1c6b-4ac0-ae53-9b8d2f1a0c04', 35.0, 65.0, 1.5, 2.5),    -- Militia (50hp, avg 2)

...
@main struct HeroHUDProbe: App {
    @UIApplicationDelegateAdaptor(AppDelegate.self) private var delegate
    private let store = Store()
    var body: some Scene { WindowGroup { HeroHUDProbeScreen(store: store) } }
}

private struct HeroHUDProbeScreen: View {
    let store: Store
            ...
            do {
                ...
                for small in [false, true] {
                    ...
                    let views: [(String, AnyView)] = [
                        ("washington-before", AnyView(PreviousHeroHUDButton(iconName: "hero_icon_george_washington", name: "Washington", buttonSize: side, isAvailable: true, isSelected: false, action: {}))),
                        ...
                        ("washington-ready", AnyView(HeroHUDButton(iconName: "hero_icon_george_washington", name: "Reference hero", buttonSize: side, isAvailable: true, isSelected: false, action: {}))),
                        ("washington-selected", AnyView(HeroHUDButton(iconName: "hero_icon_george_washington", name: "Washington", buttonSize: side, isAvailable: true, isSelected: true, action: {}))),
                        ("washington-unavailable", AnyView(HeroHUDButton(iconName: "hero_icon_george_washington", name: "Washington", buttonSize: side, isAvailable: false, isSelected: false, action: {}))),
                    ...
                    captures.append(["mode": mode, "playableHeight": canvas.playAreaRect.height,
                        "buttonSide": side, "washingtonImageSide": side, "knoxImageSide": side, "reinforcementIconSide": side * HudSizing.paintedButtonIconFraction])
                }
...
/// The generated portrait is one RGB painting. Clip only the exterior around
/// its metal corners, leaving the painted headroom and background untouched.
private struct PreviousKnoxHUDFrameOutline: Shape {

...
PREVIOUS = REPORT.parent / 'knox-background-2026-09-10/device-documents'
ART = REPORT.parents[3] / 'in-defense-of-history-data/ArtReadability/reports/knox-regenerated-2026-09-10'
results = []
for mode in ['minimum', 'device']:
    for density in [1, 2, 3]:
        ...
        filename = f'knox-ready-{mode}@{density}x.png'
...
for col,(name,label) in enumerate([('knox-before','Before'),('knox-ready','New artwork'),('knox-selected','Selected')]):
...
proof.save(ART/'knox-regenerated-minimum@1x.png')

...
source = Image.open(DATA / 'ArtReadability/reports/gold-crown-half-tilt-2026-09-10/corrected-diagnostic@3x.png').convert('RGBA')
...
for level in results['levels']:
    for density in (1, 3):
        ...
        for point in level['positions']:
            ...
            side = level['minimumBoxPoints'] * density * 2  # padded diagnostic canvas, unchanged source frame

...
BUNDLE_ID = 'com.zippyzen.available-slot-probe'
RUN_ID = str(uuid.uuid4())

def run(*args, **kwargs):
    return subprocess.run(args, check=True, **kwargs)

with tempfile.TemporaryDirectory(prefix='td-grass-probe-') as temp_name:
    temp = Path(temp_name)
    root = temp / GAME.name
    root.mkdir()
    ...
    print("PASS: compiled available-site sprite, real build transition, and physical-iPhone gameplay captures.")

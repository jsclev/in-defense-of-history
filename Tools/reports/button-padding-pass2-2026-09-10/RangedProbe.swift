...
@MainActor private func savePaddingButtons(canvas: RuntimeCanvas, layout: TowerMenuLayout, mode: String, directory: URL) throws {
    ...
    let views: [(String, AnyView, CGFloat)] = [
        ("gun-before", AnyView(HudButtonView(iconName: "tower_menu_ranged_square", buttonSize: tower, iconScale: 0.72, frameName: "hud_misc_sack_blue_frame") {}), tower),
        ...
        ("sack-before", AnyView(HudButtonView(iconName: "hud_misc_sack", buttonSize: misc, iconScale: 0.72, frameName: "hud_misc_sack_blue_frame") {}), misc),
        ("sack-after", AnyView(HudMiscView(runtimeCanvas: canvas)), misc),
        ("swords-before", AnyView(HudButtonView(iconName: "action_icon_call_reinforcements", buttonSize: hero, iconScale: 0.72) {}), hero),
        ...
        ("horn-before", AnyView(PreviousCallWaveArtwork(side: wave)), wave),
...
struct PreviousCallWaveArtwork: View {
    let side: CGFloat

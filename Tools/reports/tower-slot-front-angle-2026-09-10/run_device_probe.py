...
BUNDLE_ID = 'com.zippyzen.hammer-angle-probe'
RUN_ID = str(uuid.uuid4())

def run(*args, **kwargs):
    return subprocess.run(args, check=True, **kwargs)

with tempfile.TemporaryDirectory(prefix='td-hammer-probe-') as temp_name:
    temp = Path(temp_name)
    root = temp / GAME.name
    root.mkdir()
    ...
    print('PASS: updated compiled hammer, availability transition, gameplay captures; temporary probe removed.')

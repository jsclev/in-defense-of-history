...
public struct DebugLayoutGuidesView: View {
    ...
    private let tapAreaDash: [CGFloat] = [2, 6]
    ...
    private let tapAreaGuideColor = Color(red: 0.1, green: 0.8, blue: 1.0)
    ...
    private func createTapAreaView() -> some View {
        // A thinner dotted line keeps the purple play guide visible wherever
        // the two polygons share a boundary.
        let lineStyle = StrokeStyle(lineWidth: CGFloat(lineThickness) / 2, dash: tapAreaDash)

...
public struct Blueprints: Sendable {
    ...
    public init(virtualCanvas: VirtualCanvas) {
        let singleRoad = LevelBlueprint(
            ...
            intendedSolution: [
                .init(at: 1, .place(.melee, slot: 3)),
                .init(at: 2, .place(.melee, slot: 0)),
                .init(at: 35, .upgrade(slot: 3)),
                .init(at: 60, .place(.melee, slot: 2)),
                .init(at: 90, .place(.melee, slot: 4)),
        ...
        let convergingRoads = LevelBlueprint(
            ...
            intendedSolution: [
                .init(at: 1, .place(.melee, slot: 7)),
                .init(at: 2, .place(.melee, slot: 0)),
                .init(at: 3, .place(.melee, slot: 3)),
                .init(at: 22, .place(.special, slot: 5)),
                .init(at: 45, .place(.ranged, slot: 11)),
                .init(at: 65, .upgrade(slot: 7)),
                .init(at: 85, .place(.areaOfEffect, slot: 8)),
        ...
        all = [singleRoad, convergingRoads]
    }

    public func named(_ name: String) -> LevelBlueprint? {
